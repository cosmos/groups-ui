...
const baseModuleDescriptor: object = { go_import: "" };
...
export const ModuleDescriptor = {
  ...
  fromJSON(object: any): ModuleDescriptor {
    const message = { ...baseModuleDescriptor } as ModuleDescriptor;
    message.go_import =
      object.go_import !== undefined && object.go_import !== null
        ? String(object.go_import)
        : "";
    message.use_package = (object.use_package ?? []).map((e: any) =>
      PackageReference.fromJSON(e)
    );
    message.can_migrate_from = (object.can_migrate_from ?? []).map((e: any) =>
