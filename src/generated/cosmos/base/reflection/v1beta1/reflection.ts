...
const baseListAllInterfacesResponse: object = { interface_names: "" };
...
export const ListAllInterfacesResponse = {
  ...
  fromJSON(object: any): ListAllInterfacesResponse {
    ...
    message.interface_names = (object.interface_names ?? []).map((e: any) =>
      String(e)
    );
    return message;
  },
...
const baseListImplementationsRequest: object = { interface_name: "" };
...
export const ListImplementationsRequest = {
  ...
  fromJSON(object: any): ListImplementationsRequest {
    ...
    message.interface_name =
      object.interface_name !== undefined && object.interface_name !== null
