...
const baseRecord_Local: object = { priv_key_type: "" };
  ...
  fromJSON(object: any): Record_Local {
    ...
    message.priv_key =
      object.priv_key !== undefined && object.priv_key !== null
        ...
        : undefined;
    message.priv_key_type =
      object.priv_key_type !== undefined && object.priv_key_type !== null
  ...
  fromJSON(object: any): Record_Ledger {
    ...
    message.path =
      object.path !== undefined && object.path !== null
        ? BIP44Params.fromJSON(object.path)
        : undefined;
    return message;
  },
