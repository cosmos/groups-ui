...
export const DelegatorWithdrawInfo = {
  ...
  fromJSON(object: any): DelegatorWithdrawInfo {
    ...
    message.withdraw_address =
      object.withdraw_address !== undefined && object.withdraw_address !== null
  ...
  fromJSON(object: any): ValidatorOutstandingRewardsRecord {
    ...
    message.validator_address =
      ...
      object.validator_address !== null
        ...
        : "";
    message.outstanding_rewards = (object.outstanding_rewards ?? []).map(
  ...
  fromJSON(object: any): GenesisState {
    ...
    message.fee_pool =
      object.fee_pool !== undefined && object.fee_pool !== null
        ...
        : undefined;
    message.delegator_withdraw_infos = (
      object.delegator_withdraw_infos ?? []
    ).map((e: any) => DelegatorWithdrawInfo.fromJSON(e));
    message.previous_proposer =
      ...
      object.previous_proposer !== null
        ...
        : "";
    message.outstanding_rewards = (object.outstanding_rewards ?? []).map(
      (e: any) => ValidatorOutstandingRewardsRecord.fromJSON(e)
    );
    message.validator_accumulated_commissions = (
      object.validator_accumulated_commissions ?? []
    ).map((e: any) => ValidatorAccumulatedCommissionRecord.fromJSON(e));
    message.validator_historical_rewards = (
      object.validator_historical_rewards ?? []
    ).map((e: any) => ValidatorHistoricalRewardsRecord.fromJSON(e));
    message.validator_current_rewards = (
      object.validator_current_rewards ?? []
    ).map((e: any) => ValidatorCurrentRewardsRecord.fromJSON(e));
    message.delegator_starting_infos = (
      object.delegator_starting_infos ?? []
    ).map((e: any) => DelegatorStartingInfoRecord.fromJSON(e));
    message.validator_slash_events = (object.validator_slash_events ?? []).map(
      (e: any) => ValidatorSlashEventRecord.fromJSON(e)
    );
    return message;
  },
