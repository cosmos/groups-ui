...
export const BasicAllowance = {
  ...
  fromJSON(object: any): BasicAllowance {
    const message = { ...baseBasicAllowance } as BasicAllowance;
    message.spend_limit = (object.spend_limit ?? []).map((e: any) =>
      Coin.fromJSON(e)
    );
    message.expiration =
  ...
  fromJSON(object: any): PeriodicAllowance {
    ...
    message.period =
      object.period !== undefined && object.period !== null
        ...
        : undefined;
    message.period_spend_limit = (object.period_spend_limit ?? []).map(
      (e: any) => Coin.fromJSON(e)
    );
    message.period_can_spend = (object.period_can_spend ?? []).map((e: any) =>
      Coin.fromJSON(e)
    );
  ...
  fromJSON(object: any): AllowedMsgAllowance {
    ...
    message.allowance =
      object.allowance !== undefined && object.allowance !== null
        ...
        : undefined;
    message.allowed_messages = (object.allowed_messages ?? []).map((e: any) =>
      String(e)
    );
    return message;
  },
