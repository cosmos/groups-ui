...
export const MsgExecLegacyContent = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgExecLegacyContent>, I>>(
    object: I
  ): MsgExecLegacyContent {
    const message = { ...baseMsgExecLegacyContent } as MsgExecLegacyContent;
    message.content =
...
export class MsgClientImpl implements Msg {
  ...
  Vote(request: MsgVote): Promise<MsgVoteResponse> {
    ...
    const promise = this.rpc.request("cosmos.gov.v1beta2.Msg", "Vote", data);
  ...
  Deposit(request: MsgDeposit): Promise<MsgDepositResponse> {
    ...
    const promise = this.rpc.request("cosmos.gov.v1beta2.Msg", "Deposit", data);
    return promise.then((data) =>
