  ...
  fromJSON(object: any): TableDescriptor {
    ...
    message.primary_key =
      object.primary_key !== undefined && object.primary_key !== null
        ...
        : undefined;
    message.index = (object.index ?? []).map((e: any) =>
      SecondaryIndexDescriptor.fromJSON(e)
    );
    message.id =
...
const baseSecondaryIndexDescriptor: object = {
  fields: "",
  id: 0,
  unique: false,
};
