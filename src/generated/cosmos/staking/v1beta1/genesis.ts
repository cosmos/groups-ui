...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    ...
    message.last_total_power =
      object.last_total_power !== undefined && object.last_total_power !== null
        ? bytesFromBase64(object.last_total_power)
        : new Uint8Array();
    message.last_validator_powers = (object.last_validator_powers ?? []).map(
    ...
    message.unbonding_delegations = (object.unbonding_delegations ?? []).map(
