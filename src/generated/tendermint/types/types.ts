...
export const Header = {
  ...
  fromJSON(object: any): Header {
    ...
    message.last_commit_hash =
      object.last_commit_hash !== undefined && object.last_commit_hash !== null
        ? bytesFromBase64(object.last_commit_hash)
        : new Uint8Array();
    message.data_hash =
      object.data_hash !== undefined && object.data_hash !== null
        ? bytesFromBase64(object.data_hash)
        : new Uint8Array();
    message.validators_hash =
      object.validators_hash !== undefined && object.validators_hash !== null
    ...
    message.consensus_hash =
      object.consensus_hash !== undefined && object.consensus_hash !== null
    ...
    message.evidence_hash =
      object.evidence_hash !== undefined && object.evidence_hash !== null
        ? bytesFromBase64(object.evidence_hash)
        : new Uint8Array();
    message.proposer_address =
      object.proposer_address !== undefined && object.proposer_address !== null
...
export const Vote = {
  ...
  fromJSON(object: any): Vote {
    ...
    message.validator_index =
      object.validator_index !== undefined && object.validator_index !== null
...
export const CommitSig = {
  ...
  fromJSON(object: any): CommitSig {
    const message = { ...baseCommitSig } as CommitSig;
    message.block_id_flag =
      object.block_id_flag !== undefined && object.block_id_flag !== null
  ...
  fromJSON(object: any): Proposal {
    ...
    message.round =
      object.round !== undefined && object.round !== null
        ...
        : 0;
    message.pol_round =
      object.pol_round !== undefined && object.pol_round !== null
        ? Number(object.pol_round)
        : 0;
    message.block_id =
      object.block_id !== undefined && object.block_id !== null
        ? BlockID.fromJSON(object.block_id)
  ...
  fromJSON(object: any): BlockMeta {
    ...
    message.block_id =
      object.block_id !== undefined && object.block_id !== null
        ...
        : undefined;
    message.block_size =
      object.block_size !== undefined && object.block_size !== null
        ? Number(object.block_size)
        : 0;
    message.header =
      object.header !== undefined && object.header !== null
        ? Header.fromJSON(object.header)
        : undefined;
    message.num_txs =
      object.num_txs !== undefined && object.num_txs !== null
        ? Number(object.num_txs)
        : 0;
    return message;
  },
  ...
  toJSON(message: BlockMeta): unknown {
    ...
    message.block_id !== undefined &&
      (obj.block_id = message.block_id
        ? BlockID.toJSON(message.block_id)
        : undefined);
    message.block_size !== undefined &&
      (obj.block_size = Math.round(message.block_size));
    message.header !== undefined &&
      (obj.header = message.header ? Header.toJSON(message.header) : undefined);
    message.num_txs !== undefined &&
...
export const TxProof = {
  ...
  fromJSON(object: any): TxProof {
    const message = { ...baseTxProof } as TxProof;
    message.root_hash =
      object.root_hash !== undefined && object.root_hash !== null
