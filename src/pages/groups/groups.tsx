        ...
        <Table>
          <TableHead className={tableStyle.tableHead}>
            <TableRow className={tableStyle.tableRow}>
              ...
              <TableCell className={tableStyle.headCell}>
                Number of <br /> members
              </TableCell>
              <TableCell className={tableStyle.headCell}>
                Your <br /> membership type
              </TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {groups.map((group) => (
              <StyledTableRow
                key={group.info.id}
                className={tableStyle.tableItem}
              >
                <TableCell
                  component="th"
                  scope="row"
                  className={tableStyle.nameCol}
                >
                  <Link to={`/groups/${group.info.id}/admin-view`}>
                    {group.metadata.name}
                  </Link>
                </TableCell>
                ...
                <TableCell className={tableStyle.col}>
                  <span className={`${status.marker} blue`}>Member</span>
                </TableCell>
              </StyledTableRow>
            ))}
          </TableBody>
