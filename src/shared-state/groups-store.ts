...
import { GroupInfo, GroupMember, GroupPolicyInfo, PercentageDecisionPolicy } from '../generated/cosmos/group/v1/types'
import {
...
export class GroupsStore {
    ...
    createGroup = async (): Promise<[number, DeliverTxResponse[]]> => {
        ...
        const msg1: MsgCreateGroupWithPolicy = {
            ...
            decision_policy: {
                type_url: `/${protobufPackage}.PercentageDecisionPolicy`,
